...
class NewSalesManRoute extends StatefulWidget {
  NewSalesManRoute({this.userName, this.date});
  final userName;
  final date;

  @override
  State<NewSalesManRoute> createState() => _NewSalesManRouteState();
}

class _NewSalesManRouteState extends State<NewSalesManRoute> {
  ...
  getMarker() async {
    ...
    setState(() {
      polyline.add(Polyline(
          polylineId: PolylineId("test"), points: _poly, color: Colors.blue));
    });
    // print(key);
  }
