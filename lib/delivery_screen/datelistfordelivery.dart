...
import 'package:skr_tracker/delivery_screen/delivery_route.dart';
import 'package:skr_tracker/salesman_route_screen.dart';

class DateListForDelivery extends StatefulWidget {
  DateListForDelivery({this.number});
  final number;

  @override
  State<DateListForDelivery> createState() => _DateListForDeliveryState();
}

class _DateListForDeliveryState extends State<DateListForDelivery> {
  List<DateTime> date = [];
  getDate() async {
